...
else if(isset($_POST['submit5'])) //module nik
{
  ...
  else
  {
    ...
    $sql = "SELECT * FROM logincompany WHERE username = '".$username."' AND password = '".$password."' limit 1";
      ...
      <table>
        ...
        <tr>
          ...
          <br><br>
            ...
            <br><br>
            <button onclick="myFunction()" name="submit5">Log as Company</button>
          </td>
          <td>
