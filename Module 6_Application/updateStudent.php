<?php
	...
	$Stu_NoTel = $_GET['Stu_NoTel'];
	$Stu_Email = $_GET['Stu_Email'];
	$Comp_Selection = $_GET['Comp_Selection'];
?>
...
<caption><h2> Update Student Information </h2><caption>
...
<fieldset style="border-color:green">
	...
	<form action="studentApplication" method="GET">
		<table>
			...
			<tr><th>Student Name</th><td><input type="text" name="Stu_Name" value="<?php echo "$Stu_Name" ?>"></td></tr>
			
			<tr><th>Phone Number</th><td><input type="text" name="Stu_NoTel" value="<?php echo "$Stu_NoTel" ?>"></td></tr>
			
			<tr><th>Email</th><td><input type="text" name="Stu_Email" value="<?php echo "$Stu_Email" ?>"></td></tr>

			<tr><th class="smallcolumn">Company Selection</th>
				<td><input type="select" name="Comp_Selection" value="<?php echo "$Comp_Selection" ?>" ></td></tr>
...
<?php
	...
	if($_GET['edit'])
	{
		...
		$query = "UPDATE internshipstudent SET Stu_Name='$Stu_Name', Stu_NoTel='$Stu_NoTel', Stu_Email='$Stu_Email', Comp_Selection='$Comp_Selection' where Stu_Name='$Stu_Name';
