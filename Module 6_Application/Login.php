...
<body>
  ...
  <div class="border">
    ...
    <div class="logo">
      ...
      <img src="Logo UMP-Official.png" alt="Logo UMP">
    </div>
      ...
      <table>
        ...
        <tr>
          <td>
           ...
           <br><br>
              <button onclick="myFunction()">Log as Industry Supervisor</button>
           <br><br>
              <button onclick="myFunction()"><a href="studentLogin.php">Log as Student</button>
           <br><br>
              <button onclick="myFunction()"><a href="CSLogin.php">Login to Company Registration & Student Application</button>
          </td>
          <td>
